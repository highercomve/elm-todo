...
Elm.Components.Actions = Elm.Components.Actions || {};
Elm.Components.Actions.make = function (_elm) {
   "use strict";
   _elm.Components = _elm.Components || {};
   _elm.Components.Actions = _elm.Components.Actions || {};
   if (_elm.Components.Actions.values) return _elm.Components.Actions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var newTask = F2(function (id,description) {    return {description: description,completed: false,id: id};});
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoOp": return model;
         case "SetNewTaskDescription": return _U.update(model,{newTaskField: _p0._0});
         default: return _U.update(model,
           {nextId: $String.isEmpty(model.newTaskField) ? model.nextId + 1 : model.nextId
           ,newTaskField: ""
           ,tasks: $String.isEmpty(model.newTaskField) ? model.tasks : A2($Basics._op["++"],
           model.tasks,
           _U.list([A2(newTask,model.nextId,model.newTaskField)]))});}
   });
   var TodoModel = F4(function (a,b,c,d) {    return {tasks: a,visibility: b,newTaskField: c,nextId: d};});
   var Task = F3(function (a,b,c) {    return {description: a,completed: b,id: c};});
   var Completed = {ctor: "Completed"};
   var Incompleted = {ctor: "Incompleted"};
   var All = {ctor: "All"};
   var emptyModel = {tasks: _U.list([A2(newTask,0,"Probando ELM")]),visibility: All,nextId: 1,newTaskField: ""};
   var AddTask = {ctor: "AddTask"};
   var SetNewTaskDescription = function (a) {    return {ctor: "SetNewTaskDescription",_0: a};};
   var NoOp = {ctor: "NoOp"};
   return _elm.Components.Actions.values = {_op: _op
                                           ,NoOp: NoOp
...
Elm.Components = Elm.Components || {};
Elm.Components.Form = Elm.Components.Form || {};
Elm.Components.Form.Main = Elm.Components.Form.Main || {};
Elm.Components.Form.Main.make = function (_elm) {
   "use strict";
   _elm.Components = _elm.Components || {};
   _elm.Components.Form = _elm.Components.Form || {};
   _elm.Components.Form.Main = _elm.Components.Form.Main || {};
   if (_elm.Components.Form.Main.values) return _elm.Components.Form.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Components$Actions = Elm.Components.Actions.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var getTargetValue = function (keyCode) {    return A2($Json$Decode.customDecoder,keyCode,is13);};
   var view = F2(function (address,task) {
      return A2($Html.header,
      _U.list([]),
      _U.list([$Html.text("My todo List With Elm")
              ,A2($Html.div,
              _U.list([]),
              ...
              _U.list([$Html$Attributes.id("new-todo")
                      ...
                      function (_p1) {
                         return A2($Signal.message,address,$Components$Actions.SetNewTaskDescription(_p1));
                      })
                      ,A2(onEnter,address,$Components$Actions.AddTask)]),
              _U.list([]))]))]));
   });
   return _elm.Components.Form.Main.values = {_op: _op,view: view,getTargetValue: getTargetValue,onEnter: onEnter,is13: is13};
};
Elm.Components = Elm.Components || {};
Elm.Components.Item = Elm.Components.Item || {};
Elm.Components.Item.Main = Elm.Components.Item.Main || {};
Elm.Components.Item.Main.make = function (_elm) {
   "use strict";
   _elm.Components = _elm.Components || {};
   _elm.Components.Item = _elm.Components.Item || {};
   _elm.Components.Item.Main = _elm.Components.Item.Main || {};
   if (_elm.Components.Item.Main.values) return _elm.Components.Item.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F2(function (address,task) {    return A2($Html.li,_U.list([]),_U.list([$Html.text(task.description)]));});
   return _elm.Components.Item.Main.values = {_op: _op,view: view};
};
Elm.Components = Elm.Components || {};
Elm.Components.List = Elm.Components.List || {};
Elm.Components.List.Main = Elm.Components.List.Main || {};
Elm.Components.List.Main.make = function (_elm) {
   "use strict";
   _elm.Components = _elm.Components || {};
   _elm.Components.List = _elm.Components.List || {};
   _elm.Components.List.Main = _elm.Components.List.Main || {};
   if (_elm.Components.List.Main.values) return _elm.Components.List.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Components$Item$Main = Elm.Components.Item.Main.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F2(function (address,tasks) {    return A2($Html.ul,_U.list([]),A2($List.map,$Components$Item$Main.view(address),tasks));});
   return _elm.Components.List.Main.values = {_op: _op,view: view};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Components$Actions = Elm.Components.Actions.make(_elm),
   $Components$Form$Main = Elm.Components.Form.Main.make(_elm),
   $Components$List$Main = Elm.Components.List.Main.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Components$Form$Main.view,address,model.newTaskField),A2($Components$List$Main.view,address,model.tasks)]));
   });
   var main = $StartApp$Simple.start({model: $Components$Actions.emptyModel,update: $Components$Actions.update,view: view});
